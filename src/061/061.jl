...
# ╔═╡ 5824231b-bf1e-44bf-9c5e-5b002d4f0e95
pol(n) = [tri3(n), squ4(n), pen5(n), hex6(n), hep7(n), oct8(n)]

# ╔═╡ e10b4a8b-f93c-4c3f-94af-9387e8507259
let
	label = fill(0, oct8(200))
	for n in 2:200
		if any(label[pol(n)] .!= 0)
			@show n, pol(n), label[pol(n)]
			break
		end
		label[pol(n)] .= [3,4,5,6,7,8]
	end
end	
